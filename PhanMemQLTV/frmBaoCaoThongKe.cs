...
namespace PhanMemQLTV
{
    public partial class frmBaoCaoThongKe : Form
    {
        ...
        {
            string strTimSLDGQuaHan = @"SELECT MaDG as 'Mã DG', count(SLMuon) as 'SL Sách Mượn' from tblHSPhieuMuon where CONVERT (datetime, NgayTra, 103) <= getdate() group by MaDG";
